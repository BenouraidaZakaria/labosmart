...
<div>
    ...
    <input class="text-lg_border-1 form-control" type="text" id="valeur" name="valeur">
</div>
<div>
    <label class="text-sm" for="dateresult">dateresult</label>
    <input class="text-lg border-1 form-control" type="date" id="dateresult" name="dateresult">
</div>
<div>
